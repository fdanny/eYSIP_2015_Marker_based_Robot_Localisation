...
\begin{figure}[htbp]
\centering
\includegraphics[width = 7cm]{Blur_kernel.png}
\caption{Blur Kernel}
\end{figure}
...
\begin{figure}[htbp]
	\centering
    \includegraphics[width = 7cm]{Gaussian Kernel.png}
...
\centering
\includegraphics[width = 7cm]{Gaussfunc.png}\\
...
\begin{figure}[htbp]
\centering
\includegraphics[width = 7cm]{dots.jpg}
...
\begin{figure}
\centering
\includegraphics[width = 7cm]{Blur.jpg}
\caption{blur} 
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width = 7cm]{mountains.png}
\caption{Example image}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width = 7cm]{Median.jpg}
